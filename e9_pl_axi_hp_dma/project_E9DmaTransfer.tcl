...
#
# project_E9DmaTransfer.tcl: Tcl script for re-creating project 'project_E9DmaTransfer'
#
# Generated by Vivado on Fri Mar 24 15:07:27 +0200 2023
...
#
# 1. This project restoration tcl script (project_E9DmaTransfer.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Work/Xilinx/xProjects/project_E9DmaTransfer/project_E9DmaTransfer.srcs/sources_1/hdl/E9DmaTransferTop.v"
#    "C:/Work/Xilinx/xProjects/project_E9DmaTransfer/project_E9DmaTransfer.srcs/sources_1/ip/SyncFifoBram37x1024/SyncFifoBram37x1024.xci"
#
...
set _xil_proj_name_ "project_E9DmaTransfer"
...
set script_file "project_E9DmaTransfer.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/project_E9DmaTransfer"]"
...
set files [list \
 [file normalize "${origin_dir}/project_E9DmaTransfer/project_E9DmaTransfer.srcs/sources_1/hdl/E9DmaTransferTop.v" ]\
]
...
set file "hdl/E9DmaTransferTop.v"
...
set_property -name "top" -value "E9DmaTransferTop" -objects $obj
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/project_E9DmaTransfer/project_E9DmaTransfer.srcs/sources_1/ip/SyncFifoBram37x1024/SyncFifoBram37x1024.xci" ]\
]
set imported_files [import_files -fileset sources_1 $files]
...
# Proc to create BD E9DmaTransferPS
proc cr_bd_E9DmaTransferPS { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name E9DmaTransferPS
  ...
  set iDmaRx [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 iDmaRx ]
  ...
  set oDmaTx [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 oDmaTx ]

  # Create ports
  set oZynqClk [ create_bd_port -dir O -type clk oZynqClk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {iDmaRx:oDmaTx} \
   CONFIG.ASSOCIATED_RESET {oZynqRst} \
 ] $oZynqClk
  set oZynqRst [ create_bd_port -dir O -from 0 -to 0 -type rst oZynqRst ]
  ...
  set_property -dict [ list \
   CONFIG.PCW_ACT_APU_PERIPHERAL_FREQMHZ {533.333328} \
   CONFIG.PCW_ACT_CAN0_PERIPHERAL_FREQMHZ {23.8095} \
   CONFIG.PCW_ACT_CAN1_PERIPHERAL_FREQMHZ {23.8095} \
   CONFIG.PCW_ACT_CAN_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_DCI_PERIPHERAL_FREQMHZ {10.256410} \
   ...
   CONFIG.PCW_ACT_TTC0_CLK0_PERIPHERAL_FREQMHZ {88.888888} \
   CONFIG.PCW_ACT_TTC0_CLK1_PERIPHERAL_FREQMHZ {88.888888} \
   CONFIG.PCW_ACT_TTC0_CLK2_PERIPHERAL_FREQMHZ {88.888888} \
   CONFIG.PCW_ACT_TTC1_CLK0_PERIPHERAL_FREQMHZ {88.888888} \
   CONFIG.PCW_ACT_TTC1_CLK1_PERIPHERAL_FREQMHZ {88.888888} \
   CONFIG.PCW_ACT_TTC1_CLK2_PERIPHERAL_FREQMHZ {88.888888} \
   CONFIG.PCW_ACT_TTC_PERIPHERAL_FREQMHZ {50} \
   CONFIG.PCW_ACT_UART_PERIPHERAL_FREQMHZ {50.000000} \
   CONFIG.PCW_ACT_USB0_PERIPHERAL_FREQMHZ {60} \
   CONFIG.PCW_ACT_USB1_PERIPHERAL_FREQMHZ {60} \
   CONFIG.PCW_ACT_WDT_PERIPHERAL_FREQMHZ {88.888888} \
   ...
   CONFIG.PCW_IMPORT_BOARD_PRESET {D:/Work/zybo/ZYBO_zynq_def.xml} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {NAND Flash#unassigned#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#NAND Flash#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#UART 1#UART 1#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#SD 0#SD 0#unassigned#unassigned#unassigned#unassigned#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet 0#Enet 0} \
   CONFIG.PCW_MIO_TREE_SIGNALS {cs#unassigned#ale#we_b#data[2]#data[0]#data[1]#cle#re_b#data[4]#data[5]#data[6]#data[7]#data[3]#busy#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#tx#rx#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#cd#wp#unassigned#unassigned#unassigned#unassigned#clk#cmd#data[0]#data[1]#data[2]#data[3]#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#mdc#mdio} \
   ...
   CONFIG.PCW_SD0_GRP_WP_IO {MIO 35} \
  ...
  connect_bd_intf_net -intf_net S_AXIS_S2MM_0_1 [get_bd_intf_ports iDmaRx] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI [get_bd_intf_pins axi_dma_0/M_AXI] [get_bd_intf_pins axi_mem_intercon/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_ports oDmaTx] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports oZynqClk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_reset [get_bd_ports oZynqRst] [get_bd_pins rst_ps7_0_100M/peripheral_reset]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00008000 -offset 0x40000000 [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
...
preplace port iDmaRx -pg 1 -y 400 -defaultsOSRD
preplace port oZynqClk -pg 1 -y 670 -defaultsOSRD
preplace port oDmaTx -pg 1 -y 350 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 450 -defaultsOSRD
preplace portBus oZynqRst -pg 1 -y 880 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 2 -y 380 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 1 -y 310 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 3 -y 430 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 5 -y 600 -defaultsOSRD
preplace inst axi_smc_1 -pg 1 -lvl 3 -y 680 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 3 -y 110 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 5 -y 880 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 2 -y 590 -defaultsOSRD
preplace inst axi_bram_ctrl_1 -pg 1 -lvl 4 -y 700 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 4 -y 470 -defaultsOSRD
preplace netloc axi_dma_0_M_AXI 1 2 1 670
preplace netloc processing_system7_0_DDR 1 4 2 1530J 430 NJ
preplace netloc axi_smc_M01_AXI 1 1 1 N
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 2 3 N 590 NJ 590 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 0 5 10 230 NJ 230 NJ 230 NJ 230 1500
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 0 6 20 390 330 260 700 600 1000 620 1510J 680 1870
preplace netloc axi_smc_M00_AXI 1 1 1 300
preplace netloc processing_system7_0_FCLK_RESET0_N 1 4 1 1500
preplace netloc S_AXIS_S2MM_0_1 1 0 2 NJ 400 310J
preplace netloc axi_mem_intercon_M00_AXI 1 3 1 1020
preplace netloc axi_dma_0_M_AXI_SG 1 2 1 680
preplace netloc rst_ps7_0_100M_peripheral_reset 1 5 1 NJ
preplace netloc axi_dma_0_s2mm_introut 1 2 1 N
preplace netloc xlconcat_0_dout 1 3 1 1000
preplace netloc processing_system7_0_FIXED_IO 1 4 2 1530J 450 NJ
preplace netloc axi_dma_0_mm2s_introut 1 2 1 N
preplace netloc axi_smc_1_M00_AXI 1 3 1 N
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 10 410 320 250 690 360 1010 600 1520 670 NJ
preplace netloc axi_bram_ctrl_1_BRAM_PORTA 1 4 1 1530
preplace netloc axi_dma_0_M_AXIS_MM2S 1 2 4 670J 350 NJ 350 NJ 350 NJ
levelinfo -pg 1 -10 160 500 850 1260 1700 1890 -top -10 -bot 980
"
}
...
# End of cr_bd_E9DmaTransferPS()
cr_bd_E9DmaTransferPS ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files E9DmaTransferPS.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files E9DmaTransferPS.bd ] 
set_property IS_ENABLED "1" [get_files E9DmaTransferPS.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files E9DmaTransferPS.bd ] 
set_property IS_LOCKED "0" [get_files E9DmaTransferPS.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files E9DmaTransferPS.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files E9DmaTransferPS.bd ] 
set_property PFM_NAME "" [get_files E9DmaTransferPS.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files E9DmaTransferPS.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files E9DmaTransferPS.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files E9DmaTransferPS.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files E9DmaTransferPS.bd ] 
set_property USED_IN_SIMULATION "1" [get_files E9DmaTransferPS.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files E9DmaTransferPS.bd ] 
